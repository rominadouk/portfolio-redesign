...
const Contact = () => {
  ...
  const handleContactSubmission = (e:React.ChangeEvent) => {
    e.preventDefault();
    console.log('clicked!')
  };
       ...
       <div className='h-16 bg-nav'></div>
        ...
        <div className='flex flex-col lg:flex-row lg:gap-7'>
          ...
          <div id='contact-form-container'className=' self-center max-w-md md:max-w-lg lg:ml-28 lg:mx-0 lg:w-[27%] lg:mt-7 lg:min-w-[25%]'>
            <h2 className='mx-5 text-2xl font-semibold lg:mx-0'>Let's Connect!</h2>
            <p className='mx-5 mt-2 text-sm lg:mx-0'>Hi, if you're interested in working with me, I'd love to participate in building something great and hearing from you. As someone who is extremely passionate about development I'm always eager to develop new projects, exchange ideas, and expand my network. Even if it's not a project, I enjoy talking about all things development.</p>
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <input id='name' type='text' className=' h-8 ring-1 ring-input-border bg-input rounded-sm  p-2 lg:h-10' required />
                </div>
                {/* Email Input */}
                <div className='flex flex-col gap-2'>
                  <label htmlFor='email'>Email</label>
                  <input id='email' type='email' className=' h-8 ring-1 ring-input-border bg-input rounded-sm p-2 lg:h-10' required/>
                </div>
                {/* Message Input */}
                <div className='flex flex-col gap-2'>
                  <label htmlFor='message'>Message</label>
                  <textarea id='message' className=' h-28 ring-1 ring-input-border bg-input rounded-sm p-2' required/>
                </div>
                {/* Submit Button */}
          ...
          <div className='px-5 flex flex-col'>
                  ...
                  <a className='mt-[-25px] bg-button-color text-white py-3 px-8 rounded-md mr-5 ml-11 z-10  self-center' href='https://docs.google.com/document/d/1VJjqQIxkQx2RMIdvFQt88SFtQa5qkwPhqH6ACfeo_q8/edit?usp=sharing' target='_blank'
                  >View Resume</a>
          </div>
