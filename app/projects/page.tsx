  ...
  return (
    ...
    {projects.map((project) => {
        ...
        <div key={project.name} className=' flex flex-col pt-8 pb-12 relative'>
            ...
            <div className='z-10 md:flex md:mx-5 md:h-80 lg:mx-72'>
                {/* Project Description */}
                <div className='bg-white p-5 mt-6 w-72 ml-5 z-40 relative md:w-full md:2/3 md:self-center md:mr-[-70px] lg:mr-0 lg:w-2/4'>
                ...
                <div className=' flex flex-col mr-5 ml-11 md:w-full md:mt-10 md:mx-0 md:self-center'>
                    {/* Project Image Div */}
                    <div className='border-black h-48 mt-[-35px]  md:h-56  md:mt-12' style={{ backgroundImage: `url(${project.image.src})`, backgroundSize: 'cover' }}>
                    </div>
