    ...
    {projects.map((project) => {
        ...
        <div key={project.name} className=' flex flex-col pt-8 pb-12 relative lg:h-[450px] lg:justify-center'>
            ...
            <div className='z-10 md:flex md:mx-5 md:h-80 lg:w-1/2 lg:self-center'>
                {/* Project Description */}
                <div className='bg-white p-5 mt-6 w-72 ml-5 z-40 relative rounded-sm md:w-full md:2/3 md:self-center md:mr-[-70px] lg:mr-[-10px] lg:w-3/4 lg:mb-20'>
                ...
                <div className=' flex flex-col mr-5 ml-11 md:w-full md:mt-10 md:mx-0 md:self-center'>
                    {/* Project Image Div */}
                    <div className='h-48 mt-[-35px] rounded-sm md:h-56 ' style={{ backgroundImage: `url(${project.image.src})`, backgroundSize: 'cover' }}>
                    </div>
